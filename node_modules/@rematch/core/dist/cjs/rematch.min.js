...
for(n=Object.getOwnPropertySymbols(e);o<n.length;o++)t.indexOf(n[o])<0&&(r[n[o]]=e[n[o]])}return r}function __awaiter(i,a,c,s){return new(c||(c=Promise))(function(e,t){function r(e){try{o(s.next(e))}catch(e){t(e)}}function n(e){try{o(s.throw(e))}catch(e){t(e)}}function o(t){t.done?e(t.value):new c(function(e){e(t.value)}).then(r,n)}o((s=s.apply(i,a||[])).next())})}function __generator(r,n){var o,i,a,e,c={label:0,sent:function(){if(1&a[0])throw a[1]
return a[1]},trys:[],ops:[]}
...
return function(payload,meta){return __awaiter(e,void 0,void 0,function(){var t
...
return"function"==typeof r?r.observable?t=r.observable:(t=r("observable"),r.observable=t):t="@@observable",t}var result=symbolObservablePonyfill(root="undefined"!=typeof self?self:"undefined"!=typeof window?window:"undefined"!=typeof global?global:"undefined"!=typeof module?module:Function("return this")()),ActionTypes={INIT:"@@redux/INIT"+Math.random().toString(36).substring(7).split("").join("."),REPLACE:"@@redux/REPLACE"+Math.random().toString(36).substring(7).split("").join(".")},_typeof="function"==typeof Symbol&&"symbol"==typeof Symbol.iterator?function(e){return typeof e}:function(e){return e&&"function"==typeof Symbol&&e.constructor===Symbol&&e!==Symbol.prototype?"symbol":typeof e},_extends=Object.assign||function(e){for(var t=1;t<arguments.length;t++){var r=arguments[t]
for(var n in r)Object.prototype.hasOwnProperty.call(r,n)&&(e[n]=r[n])}return e}
function isPlainObject(e){if("object"!==(void 0===e?"undefined":_typeof(e))||null===e)return!1
...
var r=!0
return u(),c.push(t),function(){if(r){if(s)throw Error("You may not unsubscribe from a store listener while the reducer is executing. See https://redux.js.org/api-reference/store#subscribe(listener) for more details.")
r=!1,u()
var e=c.indexOf(t)
...
return(e={subscribe:function(e){if("object"!==(void 0===e?"undefined":_typeof(e))||null===e)throw new TypeError("Expected the observer to be an object.")
...
"function"==typeof e[n]&&(u[n]=e[n])}var d=Object.keys(u),f=void 0
try{assertReducerShape(u)}catch(e){f=e}return function(){var e=0<arguments.length&&void 0!==arguments[0]?arguments[0]:{},t=arguments[1]
if(f)throw f
for(var r=!1,n={},o=0;o<d.length;o++){var i=d[o],a=e[i],c=(0,u[i])(a,t)
if(void 0===c){var s=getUndefinedStateErrorMessage(i,t)
throw Error(s)}n[i]=c,r=r||c!==a}return r?n:e}}function bindActionCreator(e,t){return function(){return t(e.apply(this,arguments))}}function bindActionCreators(e,t){if("function"==typeof e)return bindActionCreator(e,t)
if("object"!==(void 0===e?"undefined":_typeof(e))||null===e)throw Error("bindActionCreators expected an object or a function, instead received "+(null===e?"null":void 0===e?"undefined":_typeof(e))+'. Did you write "import ActionCreators from" instead of "import * as ActionCreators from"?')
for(var r=Object.keys(e),n={},o=0;o<r.length;o++){var i=r[o],a=e[i]
"function"==typeof a&&(n[i]=bindActionCreator(a,t))}return n}function compose(){for(var e=arguments.length,t=Array(e),r=0;r<e;r++)t[r]=arguments[r]
return 0===t.length?function(e){return e}:1===t.length?t[0]:t.reduce(function(e,t){return function(){return e(t.apply(void 0,arguments))}})}function applyMiddleware(){for(var e=arguments.length,s=Array(e),t=0;t<e;t++)s[t]=arguments[t]
return function(c){return function(){for(var e=arguments.length,t=Array(e),r=0;r<e;r++)t[r]=arguments[r]
var n=c.apply(void 0,t),o=function(){throw Error("Dispatching while constructing your middleware is not allowed. Other middleware would not be applied to this dispatch.")},i={getState:n.getState,dispatch:function(){return o.apply(void 0,arguments)}},a=s.map(function(e){return e(i)})
return o=compose.apply(void 0,a)(n.dispatch),_extends({},n,{dispatch:o})}}}var Redux=Object.freeze({createStore:createStore,combineReducers:combineReducers,bindActionCreators:bindActionCreators,applyMiddleware:applyMiddleware,compose:compose,__DO_NOT_USE__ActionTypes:ActionTypes}),isListener=function(e){return e.includes("/")},composeEnhancersWithDevtools=function(e){void 0===e&&(e={})
...
var u=this.createRootReducer(t.rootReducers),d=applyMiddleware.apply(Redux,t.middlewares),f=composeEnhancersWithDevtools(t.devtoolOptions).apply(void 0,t.enhancers.concat([d]))
